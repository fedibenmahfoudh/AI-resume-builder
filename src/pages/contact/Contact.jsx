...
export const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "2dff79ac-8149-4ca9-8ca2-803d71814de4");
      ...
      <div className="grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-4xl bg-white font-[sans-serif]">
          ...
          <div className="mt-12">
            ...
            <ul className="flex mt-4 space-x-4">
              <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <a href="https://www.facebook.com/fedi.bnmahfoudh">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20px"
                    height="20px"
              ...
              <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <a href="https://www.linkedin.com/in/ben-mahfoudh-fedi/">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20px"
                    height="20px"
              ...
              <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <a href="https://www.instagram.com/fedy_ben_mahfoudh/">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20px"
                    height="20px"
        ...
        <form className="ml-auto space-y-4" onSubmit={onSubmit}>
          <input
            type="hidden"
            name="access_key"
            value="2dff79ac-8149-4ca9-8ca2-803d71814de4"
          />
          <input
            type="text"
            placeholder="Name"
          ...
          <button
            type="submit"
            className="text-white bg-primary hover:bg-blue-600 tracking-wide rounded-md text-sm px-4 py-3 w-full !mt-6"
          >
            Send
          </button>
        </form>
